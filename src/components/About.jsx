    ...
    return (
        <div className="flex flex-col items-center justify-center p-4 bg-slate-800 w-full h-full">
            ...
            <h2 className='text-xl md:text-xl font-bold text-center bg-gradient-to-r from-teal-400 to-lime-400 text-transparent bg-clip-text p-4 animate-textAppear'>
                Hi there, I'm <span className='animate-colorChange'>Abhilash</span>. My passion lies in the realms of web development, AI, and ML, grounded in a solid foundation of HTML, CSS, and JavaScript. Recently, I had the pleasure of working with the Appwrite framework to create a fully functional website.
                <br />
